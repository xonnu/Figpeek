...
<div class="p-10 container mx-auto fixed top-0 left-0 flex flex-col items-center justify-center lg:hidden bg-black w-full h-screen z-50">
  <h2 class="font-bold text-2xl text-white">Oops, this website is not available in mobile view.</h2>
  <p class="mt-4 text-sm text-[#b1b1b1]">Well, if you want to enable it in mobile, check out my repository and help me 🙈</p>
</div>
...
<div class="hidden w-full bg-white lg:flex items-center justify-center pointer-events-none select-none pb-24 pt-10">
